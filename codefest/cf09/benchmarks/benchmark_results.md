...
### After M4 fixes (projected target)

| Fix | Effect |
|-----|--------|
| OpenRAM SRAM replaces 32K FFs | Timing closes at 100 MHz |
| Pipelined adder tree (4 stages) | Critical path 50ns → 10ns |
| AXI4-Stream replaces SPI | Bandwidth 0.308 MB/s → 3,200 MB/s |
| Target throughput | ~400 GFLOP/s = 3.3x over SW baseline [projected] |
